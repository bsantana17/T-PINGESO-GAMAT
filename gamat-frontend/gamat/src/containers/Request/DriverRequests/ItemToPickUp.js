        ...
        <div className={pickedState}>
            ...
            <div className="row">
                ...
                <div className="row">
                    ...
                    { props.picked === true ? 
                        <button onClick={props.onChangeState} className="btn btn-sm mr-2 btn-danger">No Retirado</button>
                        : <button onClick={props.onChangeState} className="btn btn-sm mr-2 btn-success">Retirado</button>
                    }
                    </div>
                </div>
